...
import { RequisitionTypes } from '@/features/CreateRequisition/contants/RequisitionTypes';
import InfoOutlinedIcon from '@mui/icons-material/InfoOutlined';

type CreateGenericRequisitionProps = {
    onSuccess?: (type: RequisitionTypes, text: string) => void;
};

export const CreateGenericRequisition: FC<CreateGenericRequisitionProps> = ({
    onSuccess,
}) => {
    ...
    const [type, setType] = useState<RequisitionTypes | null>(null);
                    ...
                    >
                        <Stack spacing={2}>
                            ...
                            <FormControl error={!!typeError}>
                                ...
                                >
                                    {Object.values(RequisitionTypes).map(
                                        (type) => (
                                            <Option
                                                key={type}
                                                value={type}
